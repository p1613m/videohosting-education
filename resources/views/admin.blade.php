            ...
            <tr>
                ...
                <td class="text-end">
                    ...
                    @if($video->status !== 'rejected')
                        <a href="{{ route('change-status', ['video' => $video, 'status' => 'rejected']) }}" class="btn btn-sm btn-dark">Reject</a>
                    @endif
                    @if($video->status !== 'archived')
                        <a href="{{ route('change-status', ['video' => $video, 'status' => 'archived']) }}" class="btn btn-sm btn-info">Archive</a>
                    @endif
