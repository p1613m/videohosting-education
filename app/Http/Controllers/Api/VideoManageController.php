...
class VideoManageController extends Controller
{
     ...
     */
    public function update(Video $video, VideoUpdateRequest $request): Response|JsonResponse
    {
        ...
        $video->update(['status' => 'on-check'] + $request->validated());
     ...
     * @return JsonResponse|Response
     */
    public function delete(Video $video): Response|JsonResponse
    {
        if($video->user_id != Auth::user()->id) {
            return response()->json([
                'message' => 'Forbidden',
